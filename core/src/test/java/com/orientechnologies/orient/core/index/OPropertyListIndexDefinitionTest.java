...
public class OPropertyListIndexDefinitionTest {
  ...
  public void testProcessChangeEventAddOnce() {
    ...
    final OMultiValueChangeEvent<Integer, Integer> multiValueChangeEvent = new OMultiValueChangeEvent<>(
  ...
  public void testProcessChangeEventAddOnceWithConversion() {
    final Map<Object, Integer> keysToAdd = new HashMap<>();
    final Map<Object, Integer> keysToRemove = new HashMap<>();
    final OMultiValueChangeEvent<Integer, String> multiValueChangeEvent = new OMultiValueChangeEvent<>(
        OMultiValueChangeEvent.OChangeType.ADD, 0, "42");
    propertyIndex.processChangeEvent(multiValueChangeEvent, keysToAdd, keysToRemove);
  ...
  public void testProcessChangeEventAddTwoTimes() {
    final Map<Object, Integer> keysToAdd = new HashMap<>();
    final Map<Object, Integer> keysToRemove = new HashMap<>();
    final OMultiValueChangeEvent<Integer, Integer> multiValueChangeEventOne = new OMultiValueChangeEvent<>(
        OMultiValueChangeEvent.OChangeType.ADD, 0, 42);
    final OMultiValueChangeEvent<Integer, Integer> multiValueChangeEventTwo = new OMultiValueChangeEvent<>(
  ...
  public void testProcessChangeEventAddTwiceRemoveOnce() {
    ...
    final OMultiValueChangeEvent<Integer, Integer> multiValueChangeEventTwo = new OMultiValueChangeEvent<>(
        OMultiValueChangeEvent.OChangeType.ADD, 1, 42);
    final OMultiValueChangeEvent<Integer, Integer> multiValueChangeEventThree = new OMultiValueChangeEvent<>(
        OMultiValueChangeEvent.OChangeType.REMOVE, 0, null, 42);
