...
public class OCommandExecutorSQLUpdateTest {
  ...
  public void testUpdateRemoveAll() throws Exception {
    ...
    final ODocument r = (ODocument) db.query(new OSQLSynchQuery<>("SELECT FROM company")).get(0);
  ...
  public void testUpdateContent() throws Exception {
    ...
    try {
      ...
      Iterable result = db.query(new OSQLSynchQuery<>("select from V"));
  ...
  public void testUpdateContentParse() throws Exception {
    ...
    try {
      ...
      result = db.query(new OSQLSynchQuery<>("select from V"));
  ...
  public void testUpdateMergeWithIndex() {
    ...
    try {
      ...
      Iterable result = db.query(new OSQLSynchQuery<>("SELECT * FROM i_have_a_list WHERE types = 'aaa'"));
      ...
      result = db.query(new OSQLSynchQuery<>("SELECT * FROM i_have_a_list WHERE types = 'ccc'"));
      assertTrue(result.iterator().hasNext());

      result = db.query(new OSQLSynchQuery<>("SELECT * FROM i_have_a_list WHERE types = 'aaa'"));
  ...
  public void testUpsertSetPut() throws Exception {
    ...
    try {
      ...
      Iterable result = db.query(new OSQLSynchQuery<>("select from test"));
      ODocument doc = (ODocument) result.iterator().next();
  ...
  public void testUpdateParamDate() throws Exception {
    ...
    try {
      ...
      result = db.query(new OSQLSynchQuery<>("select from test"));
      doc = (ODocument) result.iterator().next();
      assertEquals(doc.field("birthDate"), date);
    } finally {
      db.close();
