...
public abstract class OSingleOrientDBServerBaseIT {
  ...
  @ClassRule
  public static GenericContainer container = new GenericContainer("orientdb/orientdb:latest").withEnv("ORIENTDB_ROOT_PASSWORD", "root").withExposedPorts(2480, 2424).waitingFor(Wait.forListeningPort());
